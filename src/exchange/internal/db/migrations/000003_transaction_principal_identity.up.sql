...
-- (design-demo-bootstrap.md §5.5, §8). Both columns are NULLable: wholesale
-- requests (no Delegation) leave them empty; end-user-delegated requests fill
-- them in from delegation.Verified.
